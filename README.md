...
- **接口抽象**：定义了通用的 [EventBus](file://E:\workdir\eventbus\eventbus.go#L10-L13) 接口，便于替换不同的消息中间件实现
- **发布订阅**：支持消息的发布和订阅功能
...
- [EventBus](file://E:\workdir\eventbus\eventbus.go#L10-L13)：事件总线接口定义
- [RabbitMQEventBus](file://E:\workdir\eventbus\eventbus.go#L16-L19)：RabbitMQ 实现的具体结构体
- [NewRabbitMQEventBus](file://E:\workdir\eventbus\eventbus.go#L22-L49)：创建事件总线实例的工厂函数
...
- [Subscribe(ctx, topic, handler)](file://E:\workdir\eventbus\eventbus.go#L12-L12) - 订阅指定主题的消息
